...
describe("Category Service Integration Tests (database)", () => {
  ...
  describe("allCategories", () => {
    it(
      "should return all categories from the database",
      async () => {
  ...
  describe("findById", () => {
    it(
      "should return a category when it exists",
      async () => {
    ...
    it(
      "should throw NotFoundError when category does not exist",
      async () => {
    ...
    it(
      "should throw ValidationError when id is invalid",
      async () => {
    ...
    it(
      "should wrap unexpected errors as InternalServerError",
      async () => {
        // create a repo stub that throws
        const badRepo: Partial<CategoryRepository> = {
          findOne() {
            return Promise.reject(new Error("boom"));
          },
        };
        const badService = categoryService(badRepo as CategoryRepository);
        await expect(badService.findById(1)).rejects.toThrow(
          InternalServerError,
        );
      },
      TEST_TIMEOUT,
  ...
  describe("findMany", () => {
    it(
      "should return empty array when given an empty ids array",
      async () => {
    ...
    it(
      "should validate ids inside the array",
      async () => {
    ...
    it(
      "should return the requested categories when ids provided",
      async () => {
