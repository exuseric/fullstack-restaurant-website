...
export function SearchPresenterMobile() {
  ...
  return (
    <>
      ...
      >
        <Modal className="entering:animate-in exiting:animate-out entering:slide-in-from-bottom exiting:slide-out-to-bottom bg-surface fixed right-0 bottom-0 left-0 z-50 h-[85vh] rounded-t-2xl shadow-lg duration-300">
          <SearchModalContent
            query={query}
            setQuery={setQuery}
            results={results}
