...
export function ListBox<T extends object>(
  ...
  return (
    <AriaListBox {...props} className={composeTailwindRenderProps(props.className, 'outline-0 p-1 w-[200px] bg-white dark:bg-neutral-900 border border-neutral-200 border-neutral-300 dark:border-neutral-700 rounded-lg font-sans dark:border-neutral-800')}>
      {children}
    </AriaListBox>
  );
}
