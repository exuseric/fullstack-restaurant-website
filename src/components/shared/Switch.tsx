...
const track = tv({
  extend: focusRing,
  base: 'flex h-5 w-9 box-border px-px items-center shrink-0 cursor-default rounded-full transition duration-200 ease-in-out shadow-inner border border-neutral-200 border-transparent font-sans dark:border-neutral-800',
  variants: {
    isSelected: {
