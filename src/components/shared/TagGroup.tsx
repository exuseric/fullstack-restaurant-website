...
import { Description, Label } from '@/components/shared/Field';
...
const tagStyles = tv({
  extend: focusRing,
  base: 'transition cursor-default text-xs rounded-full border border-neutral-200 px-3 py-0.5 flex items-center max-w-fit gap-1 font-sans [-webkit-tap-highlight-color:transparent] dark:border-neutral-800',
  variants: {
    color: {
      gray: '',
      green: '',
