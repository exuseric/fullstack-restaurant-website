...
export function Tree<T extends object>(
  ...
  return (
    <AriaTree {...props} className={composeTailwindRenderProps(props.className, 'w-48 max-w-full overflow-auto relative border border-neutral-200 dark:border-neutral-700 rounded-lg dark:border-neutral-800')}>
      {children}
    </AriaTree>
  );
}
