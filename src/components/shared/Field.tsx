...
export const fieldGroupStyles = tv({
  extend: focusRing,
  base: 'group flex items-center h-9 box-border bg-white dark:bg-neutral-900 forced-colors:bg-[Field] border border-neutral-200 rounded-lg overflow-hidden transition dark:border-neutral-800',
